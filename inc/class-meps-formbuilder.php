...
if ( ! class_exists( 'Meps_Form_Builder' ) ) {
	class Meps_Form_Builder {
		...
		public function number( $field_data, $indexes ) {
			?>
			<input type="number" name="meps_session[service][<?php echo $indexes['service_index']; ?>][item][<?php echo $indexes['item_index']; ?>]" placeholder="<?php echo $field_data['placeholder']; ?>">
