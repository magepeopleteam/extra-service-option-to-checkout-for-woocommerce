...
if (!class_exists('Meps_Checkout_Service')) {
    class Meps_Checkout_Service extends MEPS
    {
        ...
        {
            add_action('woocommerce_checkout_after_customer_details', array($this, 'before_order_summary'));
            add_action('woocommerce_after_cart_table', array($this, 'before_order_summary'));
        ...
        public function before_order_summary()
        {
            ...
            // }
?>
            <div class="meps-extra-service-container">
